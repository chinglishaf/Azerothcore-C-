...
{
    AddGossipItemFor(player, GOSSIP_ICON_TRAINER, "Learn All Spells", GOSSIP_SENDER_MAIN, 1, "¿Seguro que quieres aprender todos los hechizos?", 0, false);
    AddGossipItemFor(player, GOSSIP_ICON_BATTLE, "Learn Dual Talent", GOSSIP_SENDER_MAIN, 3, "¿Seguro que quieres aprender doble talento?", 0, false);
